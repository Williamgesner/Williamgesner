...
## 🔎 Sobre mim
- 🚀 Engenheiro de Dados
- 📚 Python, SQL, Pandas, AWS, Arquitetura ELT/ELT, Otimização de Custos em Cloud, Modelagem de Dados e Versionamento de código com Git/GitHub
...
- 📊 [ETL-Project-API-Extract](https://github.com/Williamgesner/ETL-Project-API-Extract)
- 📊 [ETL-Project-Databricks](https://github.com/Williamgesner/ETL-Project-Databricks)
